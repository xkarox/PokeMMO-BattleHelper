...
class Util():
    ...
    def winEnumHandler( self, hwnd, ctx ):
            ...
            if 'pokemmo' == window_text and win32gui.IsWindowVisible( hwnd ):
                # print ( hex( hwnd ), win32gui.GetWindowText( hwnd ) )
                self.window_handle = hwnd
                
                
    #image irgendwo aufjedenfall in ein np.array hauen 
    #asnyc dis method to make the programm run faster 
    def capture_screen( self, showWindow: bool = False , showFps: bool = False):
